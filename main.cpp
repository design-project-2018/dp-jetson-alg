...
int main(int argc, const char*const* argv) {
     ...
     * YOLO DETECTION
     *
     * Run using the following command inside vm:
     * ./dp_jetson_board -source=/vagrant/footage.mp4 -cfg=/home/vagrant/darknet/cfg/yolo.cfg -model=/home/vagrant/darknet/yolo.weights -class_names=/home/vagrant/darknet/data/coco.names
     *
     */
